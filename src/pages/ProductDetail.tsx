      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-6">
            ...
            {/* Guarantee Card */}
            <div className="card-glass rounded-2xl p-6 border border-border/50">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground mb-2">Seus dados protegidos durante todo o processo</p>
